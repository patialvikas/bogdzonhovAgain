                ...
                child: Container(
                  ...
                  child: Column(
                    children: <Widget>[
                      ...
                      isThirdApiData?Container(
                        margin: EdgeInsets.only(top: 10),
                        child: Text(tailbar_data),):Container(),

                      isThirdApiData?Container(
                        margin: EdgeInsets.only(top: 10),
                        child: Text("zasal"),):Container(),

                      isThirdApiData?Container(
                        margin: EdgeInsets.only(top: 10),
                        child: Text(zasal_data),):Container()
...
if(body1[i]["onsar"].toString()==jsonData['year'].toString()
  ...
  tailbar_data=utf8.decode(body1[i]["tailbar"].runes.toList());
//var z1=utf8.decode(body1[i]["zasal"].runes.toList());
  //var zasal=body1[i]["zasal"][0].toString();
  print ("zasal:"+body1[i]["zasal"].toString());
  var a=jsonEncode(body1[i]["zasal"]);
  print("a"+a.toString());
  Map<String, dynamic> map=json.decode(utf8.decode(a.runes.toList()));


zasal_data=map.toString();
  zasal_data =zasal_data.replaceAll("{", "").replaceAll("}", "");
